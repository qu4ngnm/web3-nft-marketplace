          ...
          <div className="flex-1 flex items-stretch overflow-hidden">
            <main className="flex-1 overflow-y-auto">
              <div className="pt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex">
                  <h1 className="flex-1 text-2xl font-bold text-gray-900">NFTs của bạn</h1>
                </div>
                      ...
                      <li
                        ...
                        >
                          ...
                          <button type="button" className="absolute inset-0 focus:outline-none">
                            <span className="sr-only">Xem chi tiết {nft.meta.name}</span>
                          </button>
                        </div>
            ...
            { activeNft &&
              <div className="pb-16 space-y-6">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Thông tin</h3>
                ...
                <div className="flex">
                  ...
                  >
                    {activeNft.isListed ? "Đã được đăng bán": "Đăng bán"}
                  </button>
                </div>
              </div>
            }
